 ...
 * api.x.ai endpoint, so `toAuth` routes requests there via a baseUrl
 * override.
 *
...
function credentialsFromTokenPayload(data: XaiTokenPayload, fallbackRefresh = ""): OAuthCredential {
