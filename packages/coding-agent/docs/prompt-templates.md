> draht can create prompt templates. Ask it to build one for your workflow.
...
draht loads prompt templates from:

- Global: `~/.draht/agent/prompts/*.md`
- Project: `.draht/prompts/*.md` (only after the project is trusted)
