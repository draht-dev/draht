> draht can create TUI components. Ask it to build one for your use case.
...
Customize the inline working indicator shown while draht is streaming a response.
...
// Restore draht's default spinner
ctx.ui.setWorkingIndicator();
```
