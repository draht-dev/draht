import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@draht/coding-agent";
import type { Component, EditorTheme, TUI } from "@draht/tui";
