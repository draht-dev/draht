...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@draht/coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@draht/coding-agent";
