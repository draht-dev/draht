...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@draht/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@draht/tui";
