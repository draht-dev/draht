...
import { createAgentSession, ModelRuntime, SessionManager } from "@draht/coding-agent";

// Default: ModelRuntime uses ~/.pi/agent/auth.json for credentials
// and loads built-in + custom models from ~/.pi/agent/models.json
