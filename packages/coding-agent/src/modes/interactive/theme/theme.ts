...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@draht/tui";
...
const THEME_KEY = Symbol.for("@draht/coding-agent:theme");
const THEME_KEY_OLD = Symbol.for("@draht/coding-agent:theme");
...
export function getSettingsListTheme(): import("@draht/tui").SettingsListTheme {
	return {
