...
import type { AssistantMessage, Model } from "@draht/ai";
...
vi.mock("@draht/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@draht/ai/compat")>();
	return {
		...actual,
