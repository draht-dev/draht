...
|---|---|
| Claude Code | `/draht:<command>` slash commands for the 21 command skills (for example `/draht:plan-phase`); the 13 discipline skills load automatically by description match or on request |
