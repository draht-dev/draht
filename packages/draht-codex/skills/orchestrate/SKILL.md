---
name: orchestrate
description: Draht command prompt wrapper for orchestrate. Use when the user selects the Draht orchestrate workflow or wants to decompose a task and coordinate specialist subagents.
---

# Draht Command: orchestrate

This skill exposes the Draht prompt command template to Codex's `$draht` and `/skills` surfaces.

When invoked:
1. Read `../../commands/orchestrate.md` relative to this `SKILL.md`.
