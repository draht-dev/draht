---
name: resume-work
description: Draht command prompt wrapper for resume-work. Use when the user selects the Draht resume-work workflow or wants to resume from a CONTINUE-HERE handoff document.
---

# Draht Command: resume-work

This skill exposes the Draht prompt command template to Codex's `$draht` and `/skills` surfaces.

When invoked:
1. Read `../../commands/resume-work.md` relative to this `SKILL.md`.
