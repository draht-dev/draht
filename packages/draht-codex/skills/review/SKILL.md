---
name: review
description: Draht command prompt wrapper for review. Use when the user selects the Draht review workflow or wants code review and security audit of recent changes.
---

# Draht Command: review

This skill exposes the Draht prompt command template to Codex's `$draht` and `/skills` surfaces.

When invoked:
1. Read `../../commands/review.md` relative to this `SKILL.md`.
