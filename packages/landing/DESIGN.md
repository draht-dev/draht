...
### Creative direction: "The Schaltplan"

The site borrows the visual language of a PCB wiring diagram. Copper marks connections and active states. The warm black background resembles a workbench under instrument light. Instrument Serif echoes the italic labels in technical manuals.

The system rejects Vercel-style gradients, Linear or Notion product polish used as marketing, floating screenshots, hero metrics, and other stock developer-tool patterns. If the page looks templated, the design has failed.
...
**Label and mono font.** Geist Mono (with JetBrains Mono, ui-monospace, monospace fallback)

Instrument Serif is italic at display sizes to echo technical-drawing labels. Geist Mono is terse and uppercase at label sizes. Instrument Sans handles body copy without competing with either face.
